...
interface GameApi {
    ...
    @ApiResponses(
        value = [ApiResponse(code = 200, message = "OK", response = kotlin.String::class)]
    )
    @RequestMapping(
    ...
    fun getGameLogsByGameId(
        @ApiParam(value = "UUID of the game", required = true) @PathVariable("gameId") gameId: java.util.UUID
