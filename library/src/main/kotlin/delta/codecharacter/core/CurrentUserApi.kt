...
interface CurrentUserApi {
    ...
    @ApiResponses(
        value = [ApiResponse(code = 200, message = "OK", response = CurrentUserProfileDto::class), ApiResponse(code = 401, message = "Unauthorized")]
    )
    @RequestMapping(
    ...
    @ApiResponses(
        value = [ApiResponse(code = 204, message = "No Content"), ApiResponse(code = 400, message = "Bad Request", response = GenericErrorDto::class)]
    )
    @RequestMapping(
    ...
    fun updateCurrentUser(
        @ApiParam(value = "", required = true) @Valid @RequestBody updateCurrentUserProfileDto: UpdateCurrentUserProfileDto
    ): ResponseEntity<Unit> {
        return ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    }
    ...
    @ApiResponses(
        value = [ApiResponse(code = 204, message = "No Content"), ApiResponse(code = 400, message = "Bad Request", response = GenericErrorDto::class), ApiResponse(code = 401, message = "Unauthorized"), ApiResponse(code = 403, message = "Forbidden")]
    )
    @RequestMapping(
    ...
    fun updatePassword(
        @ApiParam(value = "", required = true) @Valid @RequestBody updatePasswordRequestDto: UpdatePasswordRequestDto
    ): ResponseEntity<Unit> {
        return ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    }
}
